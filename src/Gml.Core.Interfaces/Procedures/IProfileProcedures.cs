...
namespace GmlCore.Interfaces.Procedures
{
    public interface IProfileProcedures
    {
        ...
        Task SaveProfiles();
        Task DownloadProfileAsync(IGameProfile baseProfile, IBootstrapProgram? bootstrapProgram);
        ...
        Task<IGameProfileInfo?> RestoreProfileInfo(string profileName, IBootstrapProgram? bootstrapProgram);
