...
public class GameDownloaderProcedures : IGameDownloaderProcedures
{
    ...
    {
        var process =
            await _gameLoader.GetProcessAsync(startupOptions, user, needDownload, jvmArguments, gameArguments);
    ...
    private bool GetAssetsFolder(string osName, string osArchitecture, MinecraftLauncher launcher,
