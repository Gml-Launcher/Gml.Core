...
public class User
{
    ...
    [JsonProperty("accessToken")] public object AccessToken { get; set; }

    [JsonProperty("serverId")] public object ServerId { get; set; }

    [JsonProperty("two_factor_enabled")] public object TwoFactorEnabled { get; set; }

    [JsonProperty("two_factor_secret")] public object TwoFactorSecret { get; set; }
    ...
    [JsonProperty("perms")] public object Perms { get; set; }

    [JsonProperty("created")] public DateTime Created { get; set; }

    [JsonProperty("updated")] public DateTime Updated { get; set; }

    [JsonProperty("cloak")] public object Cloak { get; set; }

    [JsonProperty("ban")] public Ban Ban { get; set; }

    [JsonProperty("skin")] public SkinInfo Skin { get; set; }
}
